...
import urllib.parse
import signal  # Added for CTRL+C handling
...
class ProBrowser(QMainWindow):
    ...
    def navigate(self):
        ...
        if text.startswith("/") or text.startswith("localhost") or text.startswith("127.0.0.1"):
            ...
            url = f"https://google.com/search?q={urllib.parse.quote(text)}"
        else:
